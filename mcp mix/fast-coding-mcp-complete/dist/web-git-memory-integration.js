...
import { scrapeEGPProjects, testEGPConnection } from '../egp-scraper-real.js';
import {
...
export class WebDataGitMemoryIntegration {
  ...
  async integrateWebDataWithGitMemory() {
  ...
  async scrapeEGPData() {
    try {
      ...
      // Find new projects
      const existingIds = new Set(previousProjects.map(p => p.id));
...
export async function launchWebDataIntegration(gitMemoryInstance) {
...
//# sourceMappingURL=web-git-memory-integration.js.map
