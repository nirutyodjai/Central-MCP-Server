...
export class CodeIndexManager {
  ...
  async startFileWatcher() {
    ...
    const handleFileChange = this.debounce(filePath => {
  ...
  fileMatchesCriteria(filePath, fileInfo, options) {
  ...
  searchInFile(fileInfo, searchTerms) {
    const matches = [];
  ...
  calculateRelevanceScore(matches, searchTerms) {
...
//# sourceMappingURL=CodeIndexManager.js.map
